...
function Discovar() {
  return (
    <div className='grid md:grid-cols-12 items-center p-5'>
      ...
      <h1 className='font-bold text-blue-900 text-2xl md:text-4xl my-3 md:my-5'>Why You Should Choose
      PlanMake Platform</h1>
      <p className='text-gray-500 text-sm font-medium my-5'>With verified campaigns, clear organizer details, and endorsements from reputable individuals or organizations, donors can feel confident in supporting your cause.Ensure your website is mobile-friendly and optimized for people with disabilities, making it inclusive for everyone to contribute.</p>
     <div className='flex flex-col gap-y-5'>
     <div className='flex gap-x-2 border-2 rounded-xl py-5'>
        <div className='border rounded-xl p-2 ml-2'>
      ...
      <div  className='flex gap-x-2 border-2 rounded-xl py-5'>
        <div className='border rounded-xl p-2 md:ml-2'>
